...
class MontyGame:
    ...
    def reset(self) -> None:
        """
        Reset the game, randomly put a car behind a door
        """
    ...
    def choose_door(self,your_choice:int )-> int:
        """
        Player choosing a door in [1,2,3].
        """
    ...
    def final_result(self, your_choice: bool) -> bool:
        """
        Game result
        """
...
if __name__ == '__main__':
    game = MontyGame()
    print(play_game(100000, 'not_switch', game))
    print(play_game(100000, 'switch', game))
